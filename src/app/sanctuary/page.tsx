...
>
  ← Back to Home
      ...
      <p className="pt-6 leading-relaxed">
        Collective care that reimagines how we speak about and respond to domestic violence.
      </p>
    </div>
  );
    ...
    <PageWrapper>
      ...
      <ProjectLayout sidebar={sidebarContent}>
        <div className="flex flex-col gap-2 bg-[#090909]">
          ...
          <div className="divide-y divide-[#e6e6e63a]">
  ...
  <section className={`relative grid grid-cols-1 md:grid-cols-2 items-center ${splitOrColumn} min-h-[50vh] gap-12 text-white text-[1.5rem] p-[2.5rem]`}>
    ...
    <div className="leading-relaxed">
      <p className="text-[0.75rem] text-gray-400 mb-2">Dutton & Goodman, 2005; NCADV, 2020</p>
      <p>
      In the U.S., domestic violence affects 1 in 3 women and 1 in 4 men. Yet, fear and a lack of support prevent 80% of victims from seeking help.
      </p>
    </div>
  </section>
  ...
  <section className={`relative grid grid-cols-1 md:grid-cols-2 items-center ${splitOrColumn} min-h-[50vh] gap-12 text-white text-[1.5rem] p-[2.5rem]`}>
    ...
    <div className="leading-relaxed">
      <p className="text-[0.75rem] text-gray-400 mb-2">(Campbell et al., 2002; CDC, 2018)</p>
      <p>
      Survivors often live with long-term physical and emotional pain. This is made even harder by constant legal problems and safety concerns.
      </p>
    </div>
  </section>
</div>
